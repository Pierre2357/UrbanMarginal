...
public class Interface {
	 ...
	 * Liens sons
	 */
	public static final String sonAmbiance = "/sons/ambiance.wav";
	public static final String sonMort = "/sons/death.wav";
	public static final String sonCombat = "/sons/fight.wav";
	public static final String sonGO = "/sons/go.wav";
	public static final String sonBlesse = "/sons/hurt.wav";
	public static final String sonPrecedent = "/sons/precedent.wav";
	public static final String sonSuivant = "/sons/suivant.wav";
	public static final String sonBienvenue = "/sons/welcome.wav";
	
	/**
	 * Constantes nécéssaire dans plusieurs classes
	 */
	public static final String pseudo = "pseudo";
	public static final String tidle = "~";
